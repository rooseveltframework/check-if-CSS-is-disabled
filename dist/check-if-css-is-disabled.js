(function(root,factory){if(typeof exports==="object"&&typeof module==="object")module.exports=factory();else if(typeof define==="function"&&define.amd)define("checkIfCssIsDisabled",[],factory);else if(typeof exports==="object")exports["checkIfCssIsDisabled"]=factory();else root["checkIfCssIsDisabled"]=factory()})(this,(()=>/******/(()=>{// webpackBootstrap
...
/******/})()));
//# sourceMappingURL=check-if-css-is-disabled.js.map